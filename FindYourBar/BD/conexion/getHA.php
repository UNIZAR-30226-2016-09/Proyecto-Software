...
if($parametro == 00.00) {
    $sql = "select b.nombre,descripcion,direccion,edad,horarioApertura,horarioCierre,telefono,email,facebook,i.imagenId from bar b,tiene t, imagen i where ((horarioApertura<=24.00 and horarioApertura>18) or (horarioApertura=00.00)) and i.tipo='principal' and b.nombre=t.nombreId and t.imagenId=i.imagenId";
}
else {
    $sql = "select nombre,descripcion,direccion,edad,horarioApertura,horarioCierre,telefono,email,facebook,i.imagenId from bar b,tiene t, imagen i where horarioApertura<='".$parametro."' and horarioApertura>18 and i.tipo='principal' and b.nombre=t.nombreId and t.imagenId=i.imagenId";
}
