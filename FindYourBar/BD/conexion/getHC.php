...
$sql = "select b.nombre,descripcion,direccion,edad,horarioApertura,horarioCierre,telefono,email,facebook,i.imagenId from bar b,tiene t, imagen i where horarioCierre>='".$parametro."' and i.tipo='principal' and b.nombre=t.nombreId and t.imagenId=i.imagenId";
